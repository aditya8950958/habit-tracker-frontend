...
//   // Debug logging
//   useEffect(() => {
//     console.log('🔍 CustomHabitTemplate - Current step:', step);
//     console.log('🔍 CustomHabitTemplate - FormData:', formData);
//   }, [step]);
...
//     const newErrors = {};
//     console.log('🔍 CustomHabitTemplate - Validating step:', stepNumber);
...
//     console.log('🔍 CustomHabitTemplate - Validation result:', isValid, 'Errors:', newErrors);
//     return isValid;
//   };

//   // Step navigation functions
//   const nextStep = () => {
//     console.log('🔍 CustomHabitTemplate - Next button clicked, current step:', step);
    
//     if (validateStep(step)) {
//       setStep(prevStep => {
//         const newStep = prevStep + 1;
//         console.log('🔍 CustomHabitTemplate - Moving from step', prevStep, 'to step', newStep);
//         return newStep;
//       });
//       setErrors({});
//     } else {
//       console.log('🔍 CustomHabitTemplate - Validation failed, staying on step:', step);
//     }
//   };

//   const prevStep = () => {
//     console.log('🔍 CustomHabitTemplate - Previous button clicked, current step:', step);
//     setStep(prevStep => {
...
//     e.preventDefault();
//     console.log('🔍 CustomHabitTemplate - Form submitted, validating step 3');
//     if (validateStep(3)) {
//       console.log('🔍 CustomHabitTemplate - Final validation passed, submitting:', formData);
//       onSubmit(formData);
//     }
//   };
