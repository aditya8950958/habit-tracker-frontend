...
//       <div className="absolute top-10 left-10 w-32 h-32 bg-green-200/30 rounded-full animate-pulse"></div>
//       <div className="absolute bottom-10 right-10 w-40 h-40 bg-emerald-200/30 rounded-full animate-bounce"></div>
      
//       <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
//         <h2 className="text-5xl md:text-6xl font-bold mb-8 bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
...
//             <div key={index} className="flex items-center group bg-green-50 p-4 rounded-2xl hover:bg-green-100 transition-all duration-300 transform hover:scale-105 border border-green-200">
//               <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
...
//         <button className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-12 py-6 rounded-2xl text-2xl font-bold mb-6 flex items-center justify-center mx-auto transition-all duration-500 transform hover:scale-110 shadow-2xl hover:shadow-green-500/30 group">
//           <Leaf className="mr-4 h-8 w-8 group-hover:rotate-12 transition-transform duration-300" />
//           Start Building Habits Now 
//           <ArrowRight className="ml-4 h-8 w-8 group-hover:translate-x-3 transition-transform duration-300" />
//         </button>
//         <p className="text-gray-500 text-lg font-medium">Free forever. No hidden fees.</p>
//       </div>
//     </section>
//   );
// };
...
const CTA = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white relative overflow-hidden">
      {/* Subtle Background Elements - Made responsive */}
